...
const Island = ( isRotating, setIsRotating, setCurrentStage, ...props) => {
  ...
  const handlePointerDown = (e) => {
    e.stopPropagation(); //mouse click won't touch any other functions on the screen
  ...
  useFrame(() => {
    ...
    else{ //normalize the way we drag and drop our plane. 
